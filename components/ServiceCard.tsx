...
export default function ServiceCard({ title, description, imageUrl, features }: ServiceCardProps) {
  ...
  return (
    <div className="bg-sky-200 backdrop-blur-sm rounded-lg overflow-hidden shadow-lg flex flex-col">
      ...
      <div className="p-6 flex flex-col flex-grow">
        ...
        <div className="flex items-center gap-2 text-sm text-black mb-4">
          {/* Ícone de Carro */}
          <img src="/images/car-side.svg" alt="Ícone de Carro" className="h-8 w-8" />
          {/* Ícone de Moto */}
          <img src="/images/motorcycle.svg" alt="Ícone de Moto" className="h-8 w-8" />
          <span className="font-bold">Para Carros e Motos</span>
        </div>
